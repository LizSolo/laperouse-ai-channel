...
# Витрина режима отбора едет блоками внутри DRAFTS.md, поэтому отдельного статуса
# у неё нет: день с карточками и без постов сторож видит как обычный. Пятый статус
# заводился 13.08 под отдельный файл и снят в тот же день вместе с ним.
